...
public class SingleLinkedList {
	...
	public void insertLast(Object o) {
		...
		// The list is not empty, so we have to traverse it, stopping at the last
		// element
		Node crt = head;
		while (crt.next != null)
			crt = crt.next;
	...
	public Object removeFirst() throws EmptyListException {
		...
		// Clear out all pointer - the garbage collector will take care of this area in
		// memory
		crt.content = null;
		crt.next = null;
	...
	public boolean find(Object o) {
		...
		for (Node crt = head; crt != null; crt = crt.next) {
			if (o.equals(crt.content))
				return true;
		}
		return false;
	}

	public Object removeAfter(Object o) throws EmptyListException {
		if (o == null)
			throw new EmptyListException();
		Node crt = head;
		Node returnNode = crt;
		while (crt.next != null && !o.equals(crt.content)) {
			crt = crt.next;
		}
		if (crt.next == null) {
			throw new EmptyListException();
		} else if (crt.next.next == null) {
			returnNode = crt.next;
			crt.next.content = null;
			crt.next = null;
		} else {
	...
	public Object removeBefore(Object o) throws EmptyListException {
		if (o == null)
			throw new EmptyListException();
		Node crt = head;
		Node prev = crt;
